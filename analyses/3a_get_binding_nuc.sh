...
awk -v OFS='\t' -v motif_len=$3 '{print $1, $2+motif_len, $2+30-motif_len}' with_motif.bed > with_chip_head.bed
awk -v OFS='\t' -v motif_len=$3 '{print $1, $3-30+motif_len, $3-motif_len}' with_motif.bed > with_chip_tail.bed
